	...
	private static void buildDB(String fileName) {
		...
		while (input_file.hasNext()) {
			...
			case "mon":
				...
				database.add(new monCard((String) ((Object[]) returnedList[0])[0],
						(Integer) ((Object[]) returnedList[0])[1], cardType.MONSTER, (monAttribute) returnedList[1],
			...
			case "xyz":
				...
				database.add(new extraMonCard((String) ((Object[]) returnedList[0])[0],
						(Integer) ((Object[]) returnedList[0])[1], cardType.MONSTER, (monAttribute) returnedList[1],
			...
			case "pen":
				...
				database.add(new penMonCard((String) ((Object[]) returnedList[0])[0],
						(Integer) ((Object[]) returnedList[0])[1], cardType.MONSTER, (monAttribute) returnedList[1],
						(monType) returnedList[2], (Type[]) returnedList[3], pullNextTextBlock(input_file, ";"),
			...
			case "lnk":
				...
				database.add(new linkMonCard((String) ((Object[]) returnedList[0])[0],
						(Integer) ((Object[]) returnedList[0])[1], cardType.MONSTER, (monAttribute) returnedList[1],
						(monType) returnedList[2], (Type[]) returnedList[3], pullNextTextBlock(input_file, ";"),
			...
			case "spl":
				...
				database.add(new spellCard((String) ((Object[]) returnedList[0])[0],
						(Integer) ((Object[]) returnedList[0])[1], cardType.SPELL,
						(String) ((Object[]) returnedList[0])[2], (Icon) returnedList[1]));
				break;
			case "trp":
				returnedList = pullSTBaseStats(input_file, ";");

				database.add(new trapCard((String) ((Object[]) returnedList[0])[0],
						(Integer) ((Object[]) returnedList[0])[1], cardType.TRAP,
						(String) ((Object[]) returnedList[0])[2], (Icon) returnedList[1]));
				break;
			default:
